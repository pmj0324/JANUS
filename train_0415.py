...
# Runtime / outputs
output_dir = Path("./tasks/rectified_flow_0413_loglog_linformer_shiftime_v2")
save_plots = True
seed = 42
compile_model = False
print_every = 50
...
# Data
h5_path = "/home/work/icecube_janus/JANUS/GENESIS-data/22644_0921_time_shift_ft_plus1.h5"
...
plot_generated_npe_norm_floor = 0.001
plot_generated_ftime_norm_floor = 0.001
